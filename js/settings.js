...
var Settings = {
      ...
      <div class="settings-section animate-slide-up" style="animation-delay: 0.05s">
        ...
        <div class="settings-row">
          <div style="flex: 1">
            ...
            <div class="settings-row-desc">Lấy API key từ <a href="https://aistudio.google.com/apikey" target="_blank" style="color: var(--primary)">Google AI Studio</a></div>
          </div>
        </div>
        ...
        <div style="margin-top: var(--space-md)">
          <button class="btn btn-secondary btn-sm" onclick="Settings.testApiKey()">
            🧪 Test API Key
          </button>
        </div>
      </div>
  ...
  async testApiKey() {
    ...
    Utils.showToast('🧪 Đang kiểm tra...', 'info');

    try {
      const result = await GeminiAI.callGemini('Trả lời ngắn: 1+1=?', settings);
      Utils.showToast('✅ API Key hoạt động! Response: ' + result.substring(0, 50), 'success');
    } catch (err) {
